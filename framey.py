...
class App:
    ...
    def __init__(self, master):
        ...
        bp=Button(keypad, text="#", command=lambda:self.paths(master))
        ...
        speed = Frame(master)
        fmax = Button(speed, text = "max")
        fmax.config(width = 2, height = 2, font=(NONE,15), bg="green2",fg="black",borderwidth=4)
        fmax.grid(row=0,column=0)
        f23 = Button(speed, text = "2/3")
        f23.config(width = 2, height = 2, font=(NONE,15), bg="green2",fg="black",borderwidth=4)
        f23.grid(row=1,column=0)
        f13 = Button(speed, text = "1/3")
        f13.config(width = 2, height = 2, font=(NONE,15), bg="green2",fg="black",borderwidth=4)
        ...
        r13 = Button(speed, text = "-1/3")
        r13.config(width = 2, height = 2, font=(NONE,15), bg="pink",fg="black",borderwidth=4)
        r13.grid(row=4,column=0)
        r23 = Button(speed, text = "-2/3")
        r23.config(width = 2, height = 2, font=(NONE,15), bg="pink",fg="black",borderwidth=4)
        r23.grid(row=5,column=0)
        rmax = Button(speed, text = "-max")
        rmax.config(width = 2, height = 2, font=(NONE,15), bg="pink",fg="black",borderwidth=4)
        rmax.grid(row=6,column=0)
        
        
        steer.place(x=425,y=520)
        speed.place(x=950, y=20)
    ...
    def paths(self, mstr):       
        ...
        lbox =Listbox(list, height=3, selectmode=SINGLE,font=(NONE,15))
